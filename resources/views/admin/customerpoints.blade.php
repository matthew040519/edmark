            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-3">
                    ...
                    <select class="form-control" id="rtd"  name="rtd" required="">
                      ...
                      <option value="1">Customer Points</option>
                  </select>
                </div>
                            ...
                            var tr_str = "<thead>" +
                                          ...
                                          "<tbody>";
                                           for(var i=0; i<len; i++){
                                                ...
                                                var totalpoints = response['data'][i].totalpoints;
                                            ...
                                            $('#export').attr('href', 'export?process=customerpoints');
                         }
                         else{
                            // var tr_str = "<tr>" +
