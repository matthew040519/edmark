          ...
          <div class="container-xl">
            ...
            <div class="row mt-3">
              <div class="col-lg-3">
                ...
                <input type="hidden" value="debt-transaction" name="link">
                              ...
                              <div class="modal-footer">
                                <div class="w-100">
                                  <div class="row">
                                    ...
                                    <div class="col"><a href="/delete-temp?id={{ $temp_products->id }}&link=debt-transaction" class="btn btn-danger w-100">
                                        Delete
                                      </a></div>
                                  </div>
                                </div>
