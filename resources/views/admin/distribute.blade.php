          ...
          <div class="container-xl">
            ...
            <div class="row mt-3">
              <div class="col-lg-3">
                ...
                <div class="col-lg-3">
                    <label>Branch</label>
                    <select class="form-control" name="branch" required="" id="customer">
          ...
          <div class="modal-body">
            ...
            @endif
              ...
              <div class="row">
                ...
                <input type="hidden" value="PS" name="voucher">
                <input type="hidden" value="distribute-products" name="link">
                <div class="mb-3">
                    ...
                    <tbody class="table-tbody" >
                      @foreach($params['temp_product'] as $temp_products)
                        <tr>
                          ...
                          <td class="sort-date">{{ number_format($temp_products->total, 2)}}</td>
