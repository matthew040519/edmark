          ...
          <div class="container-xl">
            <div class="card card-lg">
              <div class="card-body">
                ...
                <p class="text-secondary text-center mt-5">End of Inventory Summary</p>
              </div>
            </div>
          </div>
        </div>
