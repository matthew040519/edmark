  ...
  <body>
    ...
    <header class="" style="background-color: white;">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <h4 style="color: green">JO HEALTH & WELLNESS CONSULTANCY SERVICES TEST TEST</h4>
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive" >
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="/landing-products" style="color: black;">Our Products</a>
              </li>
              <!-- <li class="nav-item">
          ...
          <div class="col-md-4">
            <div class="product-item">
              ...
              <div class="down-content">
                ...
                <h6>$25.75</h6> -->
                <p>‘People Helping People Succeed‘ using our 4 Pillars of Success as a guiding principle for all our daily activities.</p>
                <!-- <ul class="stars">
          ...
          <div class="col-md-4">
            <div class="product-item">
              ...
              <div class="down-content">
                <!-- <a href="#"><h4>Tittle goes here</h4></a>
                <h6>$30.25</h6> -->
                <p>To activate an entrepreneurial mindset within our distributors, giving opportunities towards wealth creation.</p>
                <!-- <ul class="stars">
                  <li><i class="fa fa-star"></i></li>
                  <li><i class="fa fa-star"></i></li>
                  <li><i class="fa fa-star"></i></li>
          ...
          <div class="col-md-4">
            <div class="product-item">
              ...
              <div class="down-content">
                <!-- <a href="#"><h4>Tittle goes here</h4></a>
                <h6>$20.45</h6> -->
                <p>To build dynamic leaders in both business and community.</p>
                <!-- <ul class="stars">
                  <li><i class="fa fa-star"></i></li>
                  <li><i class="fa fa-star"></i></li>
                  <li><i class="fa fa-star"></i></li>
          ...
          <div class="col-md-4">
            <div class="product-item">
              ...
              <div class="down-content">
                <!-- <a href="#"><h4>Tittle goes here</h4></a>
                <h6>$12.50</h6> -->
                <p>To be a socially responsible organization for the betterment of society, community and culture.</p>
                <!-- <ul class="stars">
                  <li><i class="fa fa-star"></i></li>
                  <li><i class="fa fa-star"></i></li>
                  <li><i class="fa fa-star"></i></li>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="left-content">
              <h4>Vision</h4>
              <p>The Most Sought After Value-Added MLM Membership.</p>
          ...
          <div class="col-md-6">
            <div class="left-content">
              <h4>Mission</h4>
              <p>We are fully committed to help people succeed in health, wealth, and total well-being.
</p>
              <!-- <ul class="featured-list">
                <li><a href="#">Lorem ipsum dolor sit amet</a></li>
                <li><a href="#">Consectetur an adipisicing elit</a></li>
